...
libraryDependencies += "org.apache.hadoop" % "hadoop-hdfs" % "3.3.6"
...
Compile / unmanagedJars += baseDirectory.value / "lib" / "barefoot-0.1.5.jar"
Compile / unmanagedJars += baseDirectory.value / "lib" / "barefoot-0.1.5-tracker-jar-with-dependencies.jar"
Compile / unmanagedJars += baseDirectory.value / "lib" / "barefoot-0.1.5-matcher-jar-with-dependencies.jar"
